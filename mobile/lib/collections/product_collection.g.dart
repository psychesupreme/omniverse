...
ProductCollection _productCollectionDeserialize(
  ...
  object.stockQuantity = reader.readLong(offsets[5]);
...
extension ProductCollectionByIndex on IsarCollection<ProductCollection> {
  Future<ProductCollection?> getById(String id) {
    return getByIndex(r'id', [id]);
  }

  ProductCollection? getByIdSync(String id) {
  ...
  Future<List<ProductCollection?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<ProductCollection?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(ProductCollection object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(ProductCollection object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<ProductCollection> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<ProductCollection> objects,
      {bool saveLinks = true}) {
...
extension ProductCollectionQuerySortBy
  ...
  QueryBuilder<ProductCollection, ProductCollection, QAfterSortBy> sortById() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductCollection, ProductCollection, QAfterSortBy> sortBySku() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductCollectionQuerySortThenBy
  ...
  QueryBuilder<ProductCollection, ProductCollection, QAfterSortBy> thenBySku() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sku', Sort.asc);
    });
  }
...
extension ProductCollectionQueryWhereDistinct
  ...
  QueryBuilder<ProductCollection, ProductCollection, QDistinct> distinctById(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductCollection, ProductCollection, QDistinct> distinctBySku(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ProductCollectionQueryProperty
  ...
  QueryBuilder<ProductCollection, String, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<ProductCollection, bool, QQueryOperations> isActiveProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductCollection, String, QQueryOperations> skuProperty() {
    return QueryBuilder.apply(this, (query) {
